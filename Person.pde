...
Person[] generatePeople() {
  // file for running via Processing IDE and exporting Java app
  String[] lines = loadStrings("/Users/jenny/Documents/Processing/BostonViz/data/shuffled.txt");
  
  // file for exporting applet
